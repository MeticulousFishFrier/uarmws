...
set(MSG_I_FLAGS "-Inode_example:/home/xueyelin/Thermite_Boom_Boom/Code/ROS/uarmws/src/node_example/msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/xueyelin/Thermite_Boom_Boom/Code/ROS/uarmws/src/node_example/msg/NodeExampleData.msg" NAME_WE)
add_custom_target(_node_example_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "node_example" "/home/xueyelin/Thermite_Boom_Boom/Code/ROS/uarmws/src/node_example/msg/NodeExampleData.msg" ""
)
...
_generate_msg_cpp(node_example
  "/home/xueyelin/Thermite_Boom_Boom/Code/ROS/uarmws/src/node_example/msg/NodeExampleData.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/node_example)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/node_example\")")
  # install generated code
  install(
